...
def generate_special_ros_caller(ros,prec):

    roscall = []

    if (prec == '2'):
        params = '(d_conc, Tstart, Tend, d_rstatus, d_istatus,\n\
                    ...
                    VL_GLO); '
        params_spec = '(d_conc, Tstart, Tend, d_rstatus, d_istatus,\n\
        ...
        params = '(d_conc_s, Tstart, Tend, d_rstatus_s, d_istatus,\n\
                    // values calculated from icntrl and rcntrl at host\n\
                    autonomous, vectorTol, UplimTol, method, Max_no_steps,\n\
                    ...
                    // extra - vector lenght and processor\n\
                    VL_GLO); '
        params_spec = '(d_conc_s, Tstart, Tend, d_rstatus_s, d_istatus,\n\
                    autonomous, vectorTol, UplimTol, Max_no_steps,\n\
                    d_jac0_s, d_Ghimj_s,d_varNew_s, d_K_s, d_varErr_s, d_dFdT_s, d_Fcn0_s, d_var_s, d_fix_s, d_rconst_s,\n\
                    Hmin, Hmax, Hstart, FacMin, FacMax, FacRej, FacSafe, roundoff,\n\
                    d_absTol_s, d_relTol_s,\n\
    ...
    default_call = '     Rosenbrock<<<dimGrid,dimBlock>>>' + params + '\n'

    if ( ros == '2'):
        rosscall = '     switch (method){\n\
        case 1:\n\
            Rosenbrock_ros2<<<dimGrid,dimBlock>>>' + params_spec + '\n\
            break;\n\
        default: \n' + default_call + '\n\
        \n\
                    break;\n\
        ...
        rosscall = '      switch (method){\n\
        case 2:\n\
            Rosenbrock_ros3<<<dimGrid,dimBlock>>>' + params_spec + '\n\
            break;\n\
        default: \n' + default_call + '\n\
        \n\
                    break;\n\
        ...
        rosscall = '      switch (method){\n\
        case 3:\n\
            Rosenbrock_ros4<<<dimGrid,dimBlock>>>'  + params_spec + '\n\
            break;\n\
        default: \n' + default_call + '\n\
        \n\
                    break;\n\
        ...
        rosscall = '      switch (method){\n\
        case 4:\n\
            Rosenbrock_rodas3<<<dimGrid,dimBlock>>>' + params_spec + '\n\
            break;\n\
        default: \n' + default_call + '\n\
        \n\
                    break;\n\
        ...
        rosscall = '      switch (method){\n\
        case 5:\n\
            Rosenbrock_rodas4<<<dimGrid,dimBlock>>>'  + params_spec + '\n\
            break;\n\
        default: \n' + default_call + '\n\
        \n\
                    break;\n\
...
parser.add_argument('-p', '--prec', help = 'SingleGPU will produce single precision code')
...
source_cuda["call_kernel"] = generate_special_ros_caller(ros,prec)
